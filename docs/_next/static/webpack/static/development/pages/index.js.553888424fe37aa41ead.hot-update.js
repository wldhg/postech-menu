    ...
    if (document && window) {
      ...
      __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.t.bind(null, /*! html2canvas */ "../node_modules/html2canvas/dist/html2canvas.js", 7)).then(function (h2c) {
        ...
        h2c["default"](document.querySelector('main'), {
          ...
          downloadjs__WEBPACK_IMPORTED_MODULE_2___default()(canvas.toDataURL(), "".concat(t('교내식단'), "-").concat(dateString, ".png"), 'image/png');
          setIsCapturing(false);
          setTheme(prevTheme);
          unlockTheme();
        })["catch"](function (err) {
...
//# sourceMappingURL=index.js.553888424fe37aa41ead.hot-update.js.map