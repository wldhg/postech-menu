...
var BrightnessMode = function BrightnessMode() {
  ...
  var setNightBoy = function setNightBoy(data) {
    if (typeof data !== 'boolean') {
      ...
      document.cookie = "NightBoy=".concat(data.toString(), ";expires=").concat(new Date(_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()() + 2592000).toUTCString() // 30 days
      , ";");
    }
  };
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (document.cookie.indexOf('NightBoy=true') > -1) {
      document.cookie = "NightBoy=true;expires=".concat(new Date(_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()() + 2592000).toUTCString() // 30 days
      , ";");
    } else if (document.cookie.indexOf('NightBoy=false') > -1) {
      document.cookie = "NightBoy=false;expires=".concat(new Date(_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()() + 2592000).toUTCString() // 30 days
      , ";");
    }
...
//# sourceMappingURL=index.js.7039f8d905f66b5fe576.hot-update.js.map