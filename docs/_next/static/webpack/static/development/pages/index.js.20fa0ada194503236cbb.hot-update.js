...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./components/MenuMain/Footer/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _en_d_yml__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./en.d.yml */ "./components/MenuMain/Footer/en.d.yml");
...
var CaptureMenu = function CaptureMenu() {
  var _useI18n = Object(_I18n__WEBPACK_IMPORTED_MODULE_3__["default"])(_en_d_yml__WEBPACK_IMPORTED_MODULE_6___default.a),
      t = _useI18n.t;
    ...
    if (document && window) {
      ...
      __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.t.bind(null, /*! html2canvas */ "../node_modules/html2canvas/dist/html2canvas.js", 7)).then(function (h2c) {
        ...
        h2c["default"](document.querySelector('main'), {
          ...
          var today = new Date();
          var dateString = "".concat(today.getFullYear()).concat(today.getMonth()).concat(today.getDate());
          ...
          downloadjs__WEBPACK_IMPORTED_MODULE_2___default()(canvas.toDataURL(), "".concat(t('교내식단'), "-").concat(dateString, "-").concat(selectedMealType, ".png"), 'image/png');
          setIsCapturing(false);
          setTheme(prevTheme);
          unlockTheme();
        })["catch"](function (err) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(office_ui_fabric_react__WEBPACK_IMPORTED_MODULE_1__["ActionButton"], {
    ...
    className: "".concat(_style_scss__WEBPACK_IMPORTED_MODULE_5___default.a.actionSpinner).concat(isCapturing ? " ".concat(_style_scss__WEBPACK_IMPORTED_MODULE_5___default.a.activeSpinner) : ''),
...
//# sourceMappingURL=index.js.20fa0ada194503236cbb.hot-update.js.map