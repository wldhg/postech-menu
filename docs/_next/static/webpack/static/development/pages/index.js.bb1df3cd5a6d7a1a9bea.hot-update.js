      ...
      (function () {
        ...
        var _loop = function _loop(idx) {
          menuLists.push(__jsx("div", {
            ...
            __self: this
          }, menuTitles[idx]), engTranslationRequired && __jsx("button", {
            type: "button",
            title: "Translate To English",
            className: _style_scss__WEBPACK_IMPORTED_MODULE_5___default.a.translate,
            onClick: function onClick() {
              var ntp = window.open("https://translate.google.com/?hl=en&tab=TT#view=home&op=translate&sl=ko&tl=en&text=".concat(window.encodeURIComponent(menu[menuTitles[idx]].join('\n'))), '_blank');
              ntp.focus();
            },
            __source: {
              fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.bb1df3cd5a6d7a1a9bea.hot-update.js.map