...
var Wrapper = function Wrapper(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (document.documentElement.classList.contains(_style_scss__WEBPACK_IMPORTED_MODULE_4___default.a.dark)) {
  ...
  var dispModeInit = "\n    const hour = (new Date()).getHours();\n    if (\n      (document.cookie.indexOf('NightBoy=true') >= 0) // Manually Set To Dark\n      || (window.matchMedia('(prefers-color-scheme: dark)').matches) // Dark By Default\n      || (hour < 7 && hour > 18) // Time To Dark\n    ) {\n      document.documentElement.classList.add('".concat(_style_scss__WEBPACK_IMPORTED_MODULE_4___default.a.dark, "');\n    } else {\n      document.documentElement.classList.add('").concat(_style_scss__WEBPACK_IMPORTED_MODULE_4___default.a.light, "');\n    }\n  "); // IE Detection
...
//# sourceMappingURL=index.js.52af84d7c7ea06e8dc41.hot-update.js.map