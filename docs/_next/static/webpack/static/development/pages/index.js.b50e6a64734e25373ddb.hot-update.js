...
var apiReducer = function apiReducer(state, action) {
  switch (action.type) {
    ...
    case 'FETCH_JIGOK':
      {
        getJigokMenu(state.locale);
        return state;
      }

    case 'FETCH_RIST':
      {
        getRISTMenu(state.locale);
        return state;
      }
...
var getRISTMenu = function getRISTMenu(locale) {
...
//# sourceMappingURL=index.js.b50e6a64734e25373ddb.hot-update.js.map