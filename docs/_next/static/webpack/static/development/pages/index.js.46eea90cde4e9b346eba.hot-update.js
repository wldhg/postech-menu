...
var DispLocale = function DispLocale() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (document.cookie.indexOf('EnglishFlag=true') > -1) {
      document.cookie = "EnglishFlag=true;expires=".concat(new Date(_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()() + 5184000).toUTCString() // 60 days
      , ";");
    } else if (document.cookie.indexOf('EnglishFlag=false') > -1) {
      document.cookie = "EnglishFlag=false;expires=".concat(new Date(_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()() + 5184000).toUTCString() // 60 days
      , ";");
    }
...
//# sourceMappingURL=index.js.46eea90cde4e9b346eba.hot-update.js.map