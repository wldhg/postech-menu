        ...
        var _loop = function _loop(idx) {
          menuLists.push(__jsx("div", {
            ...
            onClick: function onClick() {
              var ntp = window.open("https://translate.google.com/?vi=c#ko/en/".concat(window.encodeURIComponent(menu[menuTitles[idx]].map(function (_) {
                return _.trim();
              }).join('\n'))), '_blank');
              ntp.focus();
            },
...
//# sourceMappingURL=index.js.7b7c39e39dbf0a1f72ea.hot-update.js.map