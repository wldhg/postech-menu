...
var CaptureMenu = function CaptureMenu() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(office_ui_fabric_react__WEBPACK_IMPORTED_MODULE_1__["ActionButton"], {
    ...
    __self: this
  }, t('이 사이트는 밝기 모드 설정 저장, 언어 설정 저장만을 위해 쿠키를 사용하며, 저장한 데이터는 마지막 방문 이후 60일간 유지됩니다. 저장된 쿠키는 사용자 브라우저에서만 존재하며, 별도로 서버에 저장하지 않습니다.')), __jsx("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43
    },
    __self: this
  }, t('아지래견은 사용자가 이 사이트를 이용하는 것으로 기술한 바 대로의 쿠키 기술 사용에 동의한 것으로 간주합니다.')), __jsx(office_ui_fabric_react__WEBPACK_IMPORTED_MODULE_1__["DialogFooter"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 46
    },
...
//# sourceMappingURL=index.js.17a025b40e8cc24ffc83.hot-update.js.map