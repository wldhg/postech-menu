...
var BrightnessMode = function BrightnessMode() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (document.cookie.indexOf('NightBoy=true') > -1) {
      document.cookie = "NightBoy=true;expires=".concat(new Date(_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()() + 5184000).toUTCString() // 60 days
      , ";");
    } else if (document.cookie.indexOf('NightBoy=false') > -1) {
      document.cookie = "NightBoy=false;expires=".concat(new Date(_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()() + 5184000).toUTCString() // 60 days
      , ";");
    }
...
//# sourceMappingURL=index.js.dea5b12db29603f5b2d1.hot-update.js.map