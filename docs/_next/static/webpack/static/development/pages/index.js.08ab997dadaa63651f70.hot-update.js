...
var Wrapper = function Wrapper(props) {
  ...
  var dispModeInit = "\n    const hour = (new Date()).getHours();\n    if (\n      (document.cookie.indexOf('NightBoy=true') >= 0) // Manually Set To Dark\n      || (window.matchMedia('(prefers-color-scheme: dark)').matches) // Dark By Default\n      || (hour < 7 && hour > 18) // Time To Dark\n    ) {\n      document.documentElement.dataset.theme = '".concat(_style_scss__WEBPACK_IMPORTED_MODULE_4___default.a.dark, "';\n    } else {\n      document.documentElement.dataset.theme = '").concat(_style_scss__WEBPACK_IMPORTED_MODULE_4___default.a.light, "';\n    }\n  "); // IE Detection
...
//# sourceMappingURL=index.js.08ab997dadaa63651f70.hot-update.js.map